...
const ProjectDashboard = () => {
  ...
  return (
    <div className=" w-full bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden my-4 rounded-lg">
    
      <div className="w-full mx-auto h-screen overflow-y-auto my-5 px-5">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2 text-center">Dashboard</h1>
