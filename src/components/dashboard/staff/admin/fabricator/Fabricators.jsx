      ...
      <div className="w-full rounded-lg bg-white/70">
        <nav className="bg-white rounded-lg drop-shadow-md">
          <ul className="flex flex-row gap-2 py-3">
            <li className="px-2">
              <NavLink to="add-fabricator" className={({ isActive }) => (isActive ? 'bg-green-300 drop-shadow-lg px-5 py-2 rounded-lg font-semibold' : 'hover:bg-teal-300 rounded-lg px-5 py-2 hover:text-white')}>
                Add Fabricator
              </NavLink>
            </li>
            <li className="px-2">
