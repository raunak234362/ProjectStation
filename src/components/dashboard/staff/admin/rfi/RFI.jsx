          ...
          <div className="w-full rounded-lg bg-white/70">
            <nav className="bg-white rounded-lg drop-shadow-md">
              <ul className="flex flex-row gap-2 py-3">
                <li className="px-2">
                  <NavLink to="create-rfi" className={({ isActive }) => (isActive ? 'bg-teal-300 drop-shadow-lg px-5 py-2 rounded-lg font-semibold' : 'hover:bg-teal-200 rounded-lg px-5 py-2 hover:text-white')}>
                    Create RFI
                  </NavLink>
                </li>
                <li className="px-2">
                  <NavLink to="all-sent-rfi" className={({ isActive }) => (isActive ? 'bg-teal-300 drop-shadow-lg px-5 py-2 rounded-lg font-semibold' : 'hover:bg-teal-200 rounded-lg px-5 py-2 hover:text-white')}>
                    All Sent RFI
                  </NavLink>
                </li>
              </ul>
